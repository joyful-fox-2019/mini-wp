<template>
    <header class="bg-dark d-flex align-items-center" style="height: 10vh;">
      <nav class="p-0 navbar navbar-expand-md navbar-dark bg-dark h-100 w-100 sticky-top">
          ...
          <div class="mr-auto">
            <a @click="toHome" class="nav-link font-weight-bold text-white" style="cursor:pointer">Home <span class="sr-only">(current)</span></a>
          </div>
        
        <button class="navbar-toggler" type="button" data-toggle="collapse"  data-target="#navbars" aria-controls="navbarsExample02" aria-expanded="false" aria-label="Toggle navigation">
          <span class="navbar-toggler-icon"></span>
        </button>
      
        <div class="collapse navbar-collapse bg-dark" id="navbars">
          
          <div v-if="isLogin"  id="user-name" class="d-flex justify-content-center mx-2 ml-auto p-2">
          ...
          <div v-else @click="toLoginPage" class="d-flex justify-content-center mr-2 m-2 ml-auto">
