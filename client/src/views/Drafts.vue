<template>
  <div class="main-content flex flex-wrap justify-center" style="overflow: auto; height: 90vh;">
      <div v-for="article in articles" :key="article._id" class="article-card flex w-4/5 md:w-3/4 m-8 rounded shadow-2xl">
        <div class="flex border border-gray-500 w-1/2">
        ...
        <div class="card-body flex flex-wrap p-2 w-1/2 ">
          <div class="card-info flex flex-wrap p-1 border border-red-200 w-full" style="height: 20%;">
          ...
          <hr>
          <div class="flex p-1 flex-wrap items-end border border-blue-500 w-full"  style="height:80%;">
            <div class="my-2 w-full border border-black" v-html="summary(article.content)" style="height:50%; overflow:auto;"></div>
