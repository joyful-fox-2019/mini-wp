  ...
  methods: {
    ...
    showUpdate: function showUpdate(articleId) {
      ...
      article.get("/".concat(articleId), {
        ...
        _this4.content_edit = data.content;
      }).catch(function (err) {
        console.log(err);
      });
    }
  ...
  computed: {
    ...
    fiteredArticle: function fiteredArticle() {
      ...
      return this.articles.filter(function (article) {
        return article.title.includes(_this5.search);
      });
    }
  },
...
},{}]},{},["../../../.nvm/versions/node/v13.0.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","script.js"], null)
